...
body {
    ...
    background-color: #fffbe6; /* Màu nền vàng nhẹ */
    margin: 0;
    padding: 0;
}
...
.cart-item-info button[name="update"] {
    background-color: #e6ac00; /* Màu vàng cho nút cập nhật */
    color: #fff;
}

.cart-item-info button[name="update"]:hover {
    background-color: #d99600; /* Màu vàng đậm khi hover */
}
...
.cart-summary strong {
    font-weight: bold;
    color: #e6ac00; /* Màu vàng cho tổng cộng */
}
...
.actions a button {
    ...
    font-weight: bold;
    color: #fff;
    background-color: #e6ac00; /* Màu vàng cho nút */
    border: none;
    border-radius: 5px;
    cursor: pointer;
...
.actions a button:nth-child(2) {
    background-color: #e6ac00; /* Màu vàng cho nút thanh toán */
}
